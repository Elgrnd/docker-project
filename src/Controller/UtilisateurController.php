...
final class UtilisateurController extends AbstractController
{
    ...
    public function inscription(Request  $request, EntityManagerInterface $entityManager, FlashMessageHelperInterface $flashMessageHelperInterface, UtilisateurManagerInterface $utilisateurManager): Response
    {
