...
class UtilisateurFileRepertoireRepository extends ServiceEntityRepository
{
    ...
    //    /**
    //     * @return UtilisateurFileRepertoire[] Returns an array of UtilisateurFileRepertoire objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?UtilisateurFileRepertoire
    //    {
    //        return $this->createQueryBuilder('u')
    //            ->andWhere('u.exampleField = :val')
    //            ->setParameter('val', $value)
